...
const img = (0, _galleryItems.galleryItems).map(({ preview , original , description  })=>`<li class ="gallery__item" style="list-style: none">
            <a class="gallery__link" href="${original}">
                 <img class="gallery__image" src="${preview}"
                        alt="${description}"/>
            </a>
        </li>`).join(""); //Обьединяет все эл массива в строку.
